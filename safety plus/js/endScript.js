const spamKeywords = ["spam", "scam", "fraud", "phishing", "porn", "nudity", "lottery", "bonus", "rummy", "cash prize", "win lottery" ];
...
function checkUrl() {
  ...
  if (isSpamUrl(currentUrl)) {
    alert("Warning: This website may be unsafe!");
    
  }
  else{
    alert('The website may be safe to run!')
  }
}
